...
/**
 * 우선순위 큐 버퍼 (Back Pressure Zone 2)
 *
 * 5개의 인터널 큐(P1~P5)와 1개의 overflow 큐를 관리한다.
 * 삽입: enqueue() - 주 큐 포화 시 overflow로, 거기도 포화면 DROP.
 * 소비: consumeFlux() - Q1 -> Q2 -> overflow -> Q3 -> Q4 -> Q5 순으로 폴링.
 */
@Component
public class RobotPriorityQueueBuffer {
    ...
    private final ArrayBlockingQueue<PrioritizedEntry> q1 = new ArrayBlockingQueue<>(128);
    private final ArrayBlockingQueue<PrioritizedEntry> q2 = new ArrayBlockingQueue<>(128);
    private final ArrayBlockingQueue<PrioritizedEntry> q3 = new ArrayBlockingQueue<>(128);
    private final ArrayBlockingQueue<PrioritizedEntry> q4 = new ArrayBlockingQueue<>(128);
    private final ArrayBlockingQueue<PrioritizedEntry> q5 = new ArrayBlockingQueue<>(128);
    ...
    public void enqueue(RobotLog robotLog) {
        ...
        if (target == null || !target.offer(entry)) {
